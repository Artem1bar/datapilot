...
@router.post("/{dataset_id}/chat", response_model=ChatSessionResponse, status_code=status.HTTP_200_OK)
async def chat(
...
@router.get("/{dataset_id}/sessions", response_model=list[ChatSessionResponse], status_code=status.HTTP_200_OK)
...
@router.get("/sessions/{session_id}", response_model=ChatSessionResponse, status_code=status.HTTP_200_OK)
